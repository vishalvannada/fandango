            ...
            <div>
                ...
                <div className='row'>
                    ...
                    <div id='profile_block' className="medium-9 columns">
                        ...
                        {/*E-Mail Change*/}
                        <div className='collapse-element'><Collapsible className="panel accordion-head well" trigger="CHANGE EMAIL">
                            ...
                            <div className="panel-group">
                                ...
                                <div className="panel accordion-body " id="email-info-form">
                                    <div className="row">
                                        <form onSubmit={handleSubmit(this.onSubmit_email.bind(this))} className="email-form">
                        ...
                        {/*Password Change*/}
                        <div className='collapse-element'><Collapsible className="panel accordion-head well" trigger="CHANGE PASSWORD">
                            ...
                            <div className="panel-group">
                                ...
                                <div className="panel accordion-body " id="password-info-form">
                                    <div className="row">
                                        <form onSubmit={handleSubmit(this.onSubmit_password.bind(this))} className="password-form">
                        ...
                        {/*Add Payment*/}
                        <div className='collapse-element'><Collapsible className="panel accordion-head well" trigger="PAYMENT METHOD">
                            ...
                            <div className="panel-group">
                                ...
                                <div className="panel accordion-body " id="payment-info-form">
                                    <div className="row">
                                        ...
                                        <form onSubmit={handleSubmit(this.onSubmit_payment.bind(this))} className="payment-form">
                                            ...
                                            <div className='row'> <div className="medium-12 columns date-box">
