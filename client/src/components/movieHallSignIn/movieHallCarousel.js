...
class MovieHallCarousel extends Component {
                ...
                return (
                    <div key={movie.title}>
                        ...
                        <div className="carousel-movie-name px-2 pt-1">
                            ...
                            <span
                                className="font-timesNewRoman-gray">{moment(movie.release_date).format('MMM DD, YYYY')}</span>
                        </div>
...
export default connect(null, null)(MovieHallCarousel);
